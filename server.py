...
def query_election_data(question: str) -> str:
    ...
    try:
        ...
        try:
            ...
            logger.error("Missing required dependency: tabulate")
            return json.dumps({
                "error": "Missing required dependency: tabulate. Installing with: uv pip install tabulate"
            }, indent=2)
        ...
        party_codes = PARTY_CODE_TO_NAME
